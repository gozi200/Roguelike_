...
const int HUNGER_DANGER      = 20;     // 空腹お腹がこの値になったらメッセージを出す

const int HUNGER_HAZARD      = 0;      // 空腹お腹がこの値になったらメッセージを出す

const int FILL_HUNGER_POINT = 100;    // 満腹状態
